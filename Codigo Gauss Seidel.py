...
if __name__ == '__main__':
    ...
    # graficar
    plt.figure(figsize=(10, 5))  # o (16, 5) si quieres más horizontal aún
    plt.imshow(vx.T,origin='lower',aspect='auto',cmap='jet',extent=[0,nx-1,0,ny-1])
    plt.colorbar(label='$v_x$')
    plt.title('vx final (Newton + GS)')
